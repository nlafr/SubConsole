...
## 0.1.7 - 3/31/26
- Upper margin graphics offset when initializing with consoleRatio of 1 corrected.
<br/>&emsp;*purpose*: Correct graphics anomoly.
<br/>&emsp;*location*: ui/interface.py,  calculateWindow
